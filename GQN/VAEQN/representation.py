...
class Pyramid(nn.Module):
    def __init__(self):
        ...
        self.net = nn.Sequential(
            nn.Conv2d(8+1, 32, kernel_size=2, stride=2),
            nn.ReLU(),
    ...
    def forward(self, x, v):
        # Broadcast
        v = v.view(-1, 8, 1, 1).repeat(1, 1, 64, 64)
...
class Tower(nn.Module):
    def __init__(self):
        ...
        self.conv5 = nn.Conv2d(256+8, 256, kernel_size=3, stride=1, padding=1)
        self.conv6 = nn.Conv2d(256+8, 128, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x, v):
        ...
        # Broadcast
        v = v.view(v.size(0), 8, 1, 1).repeat(1, 1, 16, 16)
